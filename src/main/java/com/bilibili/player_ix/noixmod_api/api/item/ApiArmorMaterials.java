...
public enum ApiArmorMaterials
implements StringRepresentable, ArmorMaterial
{
    COPPER("copper", 12, Util.make(new EnumMap<>(ArmorItem.Type.class),
            (enumMap) -> {
    ...
    private ApiArmorMaterials(String pName, int pDurabilityMultiplier,
        ...
        this.repairIngredient = Suppliers.memoize(() -> pRepairIngredient);
    }
