...
public class NihilisticTree extends CocoaDecorator {
    public static final Codec<NihilisticTree> CODEC = Codec.unit(NihilisticTree::new);
    public static final TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);
    public NihilisticTree() {
        super(0.15f);
    }

    //@SubscribeEvent
    public static void registerTreeDecorator(RegisterEvent event) {
        event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES,
                registerHelper -> registerHelper.register("nihilistic_tree",
                        DECORATOR_TYPE));
    }
