...
public class NoixmodAPIEntities {
    ...
    public static final RegistryObject<EntityType<ApostleBoss>> APOSTLE = NoixmodAPIEntities.register("apostle", EntityType.Builder.<ApostleBoss>of(ApostleBoss::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).sized(0.6f, 2f).fireImmune());
    ...
    public static final RegistryObject<EntityType<ApostleShadow>> APOSTLE_SHADOW = NoixmodAPIEntities.register("apostle_shadow", EntityType.Builder.<ApostleShadow>of(ApostleShadow::new, MobCategory.MISC).sized(0.6f, 1.95f).fireImmune());
    ...
    public static final RegistryObject<EntityType<BoneSpellcaster>> BONE_SPELLCASTER = register("bone_spellcaster", EntityType.Builder.of(BoneSpellcaster::new, MobCategory.MONSTER).sized(0.6F, 1.95F));
    ...
    public static final RegistryObject<EntityType<DrunkennessServant>> DRUNKENNESS_SERVANT = register("drunkenness_servant", EntityType.Builder.of(DrunkennessServant::new, MobCategory.MISC).sized(0.6F, 1.95F));
    ...
    public static final RegistryObject<EntityType<EnderSlime>> ENDER_SLIME = register("ender_slime", EntityType.Builder.<EnderSlime>of(EnderSlime::new, MobCategory.MONSTER).sized(2.04F, 2.04F).clientTrackingRange(10));
    ...
    public static final RegistryObject<EntityType<Fighter>> FIGHTER = NoixmodAPIEntities.register("fighter", EntityType.Builder.<Fighter>of(Fighter::new, MobCategory.MONSTER).setTrackingRange(64).sized(0.6f, 1.95f).updateInterval(2));
    ...
    public static final RegistryObject<EntityType<HunterServant>> HUNTER_SERVANT = register("hunter_servant", EntityType.Builder.of(HunterServant::new, MobCategory.MISC).sized(0.6F, 1.95F));
    public static final RegistryObject<EntityType<IllusionerServant>> ILLUSIONER_SERVANT = register("illusioner_servant", EntityType.Builder.of(IllusionerServant::new, MobCategory.MISC).sized(0.6F, 1.95F));
    ...
    public static final RegistryObject<EntityType<SkeletonServant>> SKELETON_SERVANT = register("skeleton_servant", EntityType.Builder.of(SkeletonServant::new, MobCategory.MISC).sized(0.6F, 1.95F).fireImmune());
    public static final RegistryObject<EntityType<SilentGhost>> SILENT_GHOST = register("silent_ghost", EntityType.Builder.of(SilentGhost::new, MobCategory.MONSTER).sized(0.6F, 1.95F));
    ...
    public static final RegistryObject<EntityType<StarGuardian>> STAR_GUARDIAN = NoixmodAPIEntities.register("star_guardian", EntityType.Builder.<StarGuardian>of(StarGuardian::new, MobCategory.MONSTER).sized(0.6F, 1.93F).clientTrackingRange(20).fireImmune());
    ...
    public static final RegistryObject<EntityType<WitherBoneSpellcaster>> WITHER_BONE_SPELLCASTER = register("wither_bone_spellcaster", EntityType.Builder.of(WitherBoneSpellcaster::new, MobCategory.MONSTER).sized(0.6F, 1.98F).fireImmune().immuneTo(Blocks.WITHER_ROSE));
    ...
    public static final RegistryObject<EntityType<NihilisticStatue>> NIHILISTIC_STATUE = NoixmodAPIEntities.register("nihilistic_statue", EntityType.Builder.<NihilisticStatue>of(NihilisticStatue::new, MobCategory.MISC).setUpdateInterval(3).fireImmune().sized(0.5f, 3f));
    ...
    public static final RegistryObject<EntityType<StrayServant>> STRAY_SERVANT = register("stray_servant", EntityType.Builder.of(StrayServant::new, MobCategory.MISC).sized(0.6F, 1.98F));
    ...
    public static final RegistryObject<EntityType<SuicideZombie>> SUICIDE_ZOMBIE = NoixmodAPIEntities.register("suicide_zombie", EntityType.Builder.<SuicideZombie>of(SuicideZombie::new, MobCategory.MISC).sized(0.6f, 1.95f).updateInterval(3).canSpawnFarFromPlayer());
    ...
    public static void registerSpawns(SpawnPlacementRegisterEvent event) {
        ...
        event.register(NoixmodAPIEntities.AQUATIC_WORM.get(), SpawnPlacements.Type.IN_WATER,
                Heightmap.Types.OCEAN_FLOOR, (entityType, serverLevelAccessor, mobSpawnType, blockPos, randomSource) ->
                        APIMonster.checkAPIMonsterSpawnRules(entityType, serverLevelAccessor, mobSpawnType, blockPos,
                                ...
                                && ThreadLocalRandom.current().nextDouble() <= 0.05D,
                SpawnPlacementRegisterEvent.Operation.AND);
        event.register(NoixmodAPIEntities.BONE_SPELLCASTER.get(), SpawnPlacements.Type.ON_GROUND,
        ...
        && NoixmodAPIMainConfig.BoneSpellcasterSpawn.get(),
                SpawnPlacementRegisterEvent.Operation.AND);
        event.register(NoixmodAPIEntities.ENDER_SLIME.get(), SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                (pEntityType, pServerLevel, pSpawnType,
                 pPos, pRandom) -> {
            return EnderSlime.checkEnderSlimeSpawn(pEntityType, pServerLevel, pSpawnType, pPos, pRandom) &&
                    NoixmodAPIMainConfig.EndSlimeSpawn.get();
                }, SpawnPlacementRegisterEvent.Operation.AND);
        event.register(NoixmodAPIEntities.NETHER_SOUL.get(), SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                (pEntityType, pServerLevel, pSpawnType,
                 pPos, pRandom) -> {
            return NoixmodAPIMainConfig.NetherSoulSpawn.get() &&
                            APIMonster.checkApiMonsterSpawnRulesIgnoreLight(pEntityType,
                                    pServerLevel, pSpawnType, pPos, pRandom);
                }, SpawnPlacementRegisterEvent.Operation.AND);
        event.register(NoixmodAPIEntities.WITHER_BONE_SPELLCASTER.get(), SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                (pEntityType, pServerLevel, pSpawnType, pPos, pRandom) ->
                        Mob.checkMobSpawnRules(pEntityType, pServerLevel, pSpawnType, pPos, pRandom)
                                && pServerLevel.getDifficulty() != Difficulty.PEACEFUL
        ...
        event.register(NoixmodAPIEntities.PLATEAU_BEAST.get(), SpawnPlacements.Type.ON_GROUND,
                ...
                SpawnPlacementRegisterEvent.Operation.AND);
        event.register(NoixmodAPIEntities.SILENT_GHOST.get(), SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                (pEntityType, pServerLevel, pSpawnType,
                 pPos, pRandom) ->
                APIMonster.checkAPIMonsterSpawnRules(pEntityType, pServerLevel, pSpawnType, pPos, pRandom)
        && NoixmodAPIMainConfig.SilentGhostSpawn.get(), SpawnPlacementRegisterEvent.Operation.AND);
        ...
        event.register(NoixmodAPIEntities.WORM.get(), SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                (entityType, serverLevelAccessor, mobSpawnType, blockPos, randomSource) ->
                        ThreadLocalRandom.current().nextDouble() <= 0.05D && APIMonster.checkAPIMonsterSpawnRules(entityType,
        ...
        event.register(NoixmodAPIEntities.HOSTILE_YETI.get(), SpawnPlacements.Type.ON_GROUND,
                ...
                (entityType, serverLevelAccessor, mobSpawnType, blockPos, randomSource) ->
                        APIMonster.checkAPIMonsterSpawnRules(entityType, serverLevelAccessor, mobSpawnType,
                                blockPos, randomSource) && NoixmodAPIMainConfig.YetiWillSpawn.get(),
                SpawnPlacementRegisterEvent.Operation.AND);
    }
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(BONE_SPELLCASTER.get(), BoneSpellcaster.createAttributes().build());
        ...
        event.put(DRUNKENNESS_SERVANT.get(), NoixmodAPIAttributes.createDrunkennessAttributes().build());
        ...
        event.put(HUNTER_SERVANT.get(), NoixmodAPIAttributes.createHunterAttributes().build());
        event.put(ILLUSIONER_SERVANT.get(), Illusioner.createAttributes().build());
        ...
        event.put(HOSTILE_YETI.get(), Yeti.createAttributes().build());
        ...
        event.put(SILENT_GHOST.get(), SilentGhost.createAttributes().build());
        event.put(SILVERFISH_SERVANT.get(), SilverfishServant.createAttributes());
        event.put(SKELETON_SERVANT.get(), NoixmodAPIAttributes.createWitherSkeletonServantAttributes().build());
        event.put(SMALL_WORM.get(), SmallWorm.createAttributes().build());
        event.put(STAR_GUARDIAN.get(), StarGuardian.createAttributes().build());
        event.put(STRAY_SERVANT.get(), NoixmodAPIAttributes.createWitherSkeletonServantAttributes().build());
        ...
        event.put(WITHER_BONE_SPELLCASTER.get(), BoneSpellcaster.createAttributes().build());
