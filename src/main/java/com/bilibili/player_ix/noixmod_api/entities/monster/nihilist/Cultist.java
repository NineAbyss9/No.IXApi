...
implements Enemy {
    ...
    public void convert()
    {
        ...
        switch (NoixmodAPIMainConfig.CultistConversionInt.get()) {
            case 0: {
    ...
    extends UseSpellGoalA {
        private final float maxHealth = Cultist.this.getMaxHealth() - 10.0F;
        protected void castSpell() {
            Cultist.this.heal(10f);
        }

        public boolean canUse() {
            if (Cultist.this.getHealth() >= maxHealth) {
                return false;
            }
            return super.canUse();
        }
    ...
    extends CultistGoal {
        ...
        protected void castSpell() {
            ...
            MobUtils.rangeHurt(6, 6, 6, Cultist.this, Cultist.this.damageSources()
                    .indirectMagic(Cultist.this, Cultist.this), 10f);
            Cultist.this.randomTeleport(Cultist.this.getX() + Maths.randomInteger(4), Cultist.this.getY(),
                    Cultist.this.getZ() + Maths.randomInteger(4), true);
        }
