...
public class Emerging<E extends WardenServant> extends Behavior<E> {
   public Emerging(int pDuration) {
      super(ImmutableMap.of(MemoryModuleType.IS_EMERGING, MemoryStatus.VALUE_PRESENT, MemoryModuleType
              .WALK_TARGET, MemoryStatus.VALUE_ABSENT, MemoryModuleType.LOOK_TARGET, MemoryStatus
              .REGISTERED), pDuration);
   }
