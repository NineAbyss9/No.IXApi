...
public class ApiCrossbowAttackGoal<T extends Mob & CrossbowAttackMob>
extends Goal {
    ...
    public ApiCrossbowAttackGoal(T p_25814_, double speed, float radius) {
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.crossbowState == CrossbowState.UNCHARGED) {
                ...
                ItemStack itemstack1 = this.mob.getItemInHand(ProjectileUtil.getWeaponHoldingHand(
                        this.mob, (item) -> item instanceof CrossbowItem));
