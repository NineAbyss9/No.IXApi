...
public class NoixmodAPIAttributesConfig {
    ...
    static {
        ...
        apostleArmor = builder.comment("Armor amount of Apostle(s), Default : 10.0").worldRestart()
                .defineInRange("使徒盔甲值", 10.0, 0, Double.MAX_VALUE);
        apostleArmorToughness = builder.comment("ArmorToughness amount of Apostle(s), Default : 6.0").worldRestart()
                .defineInRange("使徒盔甲韧性", 6.0, 0, Double.MAX_VALUE);
        apostleMaxHealth = builder.comment("Max health amount of Apostle(s), Default : 320.0").worldRestart()
                .defineInRange("使徒最大生命值", 320.0, 0, Double.MAX_VALUE);
        apostleDamageCap = builder.comment("Damage cap of Apostle(s), Default : 12.5").worldRestart()
        ...
        headhunterHealth = builder.comment("Max health amount of Headhunters, Default : 450.0").worldRestart()
                .defineInRange("猎头者最大生命值", 450.0, 0, Double.MAX_VALUE);
        headhunterArmor = builder.comment("Armor amount of Headhunters, Default : 16.0").worldRestart()
                .defineInRange("猎头者护甲", 16.0, 0.0, Double.MAX_VALUE);
        headhunterDamageCap = builder.comment("Damage cap of Headhunters, Default : 17.0").worldRestart()
                .defineInRange("猎头者限伤", 17.0, 0.0, Double.MAX_VALUE);
        builder.pop();
        builder.pop();
        builder.push("OwnableEntity");
        builder.push("GirlGhost");
        girlGhostHealth = builder.comment("Max health amount of GirlGhosts, Default:16.0").worldRestart()
                .defineInRange("女孩幽灵最大生命值", 16.0, 0.0, Double.MAX_VALUE);
        girlGhostArmor = builder.comment("Armor amount of GirlGhosts, Default:0.0").worldRestart()
                .defineInRange("女孩幽灵盔甲值", 0.0, 0.0, Double.MAX_VALUE);
        girlGhostDamage = builder.comment("Damage amount of GirlGhosts, Default:3.0").worldRestart()
                .defineInRange("女孩幽灵伤害值", 3.0, Double.MIN_VALUE, Double.MAX_VALUE);
        builder.pop();
        builder.push("LavaZombie");
        lavaZombieArmor = builder.comment("Armor amount of LavaZombies, Default:3.0").worldRestart()
                .defineInRange("熔岩僵尸盔甲值", 3.0, 0, Double.MAX_VALUE);
        lavaZombieDamage = builder.comment("Damage amount of LavaZombies, Default:5.0").worldRestart()
                .defineInRange("熔岩僵尸伤害值", 5.0, Double.MIN_VALUE, Double.MAX_VALUE);
        lavaZombieHealth = builder.comment("Max health amount of LavaZombies, Default : 24.0").worldRestart()
                .defineInRange("熔岩僵尸最大生命值", 24.0, Double.MIN_VALUE, Double.MAX_VALUE);
        builder.pop();
        builder.pop();
        builder.push("NaturalMonsters");
        builder.push("Bloodsucker");
        vampireArmor = builder.comment("Armor amount of Bloodsuckers(Vampires), Default:0.0").worldRestart()
                .defineInRange("吸血鬼盔甲值", 0.0, 0.0, Double.MAX_VALUE);
        vampireHealth = builder.comment("Max health amount of Bloodsuckers(Vampires), Default:40.0").worldRestart()
