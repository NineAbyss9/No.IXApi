...
public class InfernalIronAnvilScreen
extends ItemCombinerScreen<InfernalIronAnvilMenu> {
    private static final ResourceLocation ANVIL_LOCATION = NoixmodAPI.location(
            "textures/gui/infernal_iron_anvil.png");
    private EditBox name;
    private final Player player;
    public InfernalIronAnvilScreen(InfernalIronAnvilMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void subInit() {
        ...
        this.name.setTextColor(0);
        this.name.setTextColorUneditable(0);
    ...
    private void onNameChanged(String p_97899_) {
        ...
        if (slot.hasItem()) {
            ...
            if (this.menu.setItemName(s)) {
                ApiNetwork.sendToServer(new InfernalAnvilRenameItemPacket(s));
            }
        }
    }
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.blit(ANVIL_LOCATION, this.leftPos + 59, this.topPos + 20, 0,
    ...
    protected void renderErrorIcon(GuiGraphics pGuiGraphics, int pX, int pY) {
        if ((this.menu.getSlot(0).hasItem() || this.menu.getSlot(1).hasItem()) && !this.menu.getSlot(
                this.menu.getResultSlot()).hasItem()) {
            pGuiGraphics.blit(ANVIL_LOCATION, pX + 99, pY + 45, this.imageWidth, 0, 28,
                    21);
        }
    }
