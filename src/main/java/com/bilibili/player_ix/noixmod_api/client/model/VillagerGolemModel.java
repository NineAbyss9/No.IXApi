...
@OnlyIn(Dist.CLIENT)
public class VillagerGolemModel<T extends VillagerGolem> extends HierarchicalModel<T> {
    ...
    public VillagerGolemModel(ModelPart p_170697_) {
        this.root = p_170697_;
    ...
    public void setupAnim(T p_102962_, float p_102963_, float p_102964_, float p_102965_, float p_102966_, float p_102967_) {
        this.head.yRot = p_102966_ * 0.017453292F;
        this.head.xRot = p_102967_ * 0.017453292F;
    ...
    public void prepareMobModel(T p_102957_, float p_102958_, float p_102959_, float p_102960_) {
        int $$4 = p_102957_.getAttackAnimationTick();
        if ($$4 > 0) {
            this.rightArm.xRot = -2.0F + 1.5F * Mth.triangleWave((float)$$4 - p_102960_, 10.0F);
            this.leftArm.xRot = -2.0F + 1.5F * Mth.triangleWave((float)$$4 - p_102960_, 10.0F);
        } else {
