...
public class AltarContainer implements CraftingContainer {
    ...
    public AltarContainer(AbstractContainerMenu pMenu) {
    ...
    public List<ItemStack> removeAllItems() {
        List<ItemStack> list = this.items.stream().filter((p_19197_) -> !p_19197_.isEmpty())
    ...
    public boolean canAddItem(ItemStack pStack) {
        ...
        for (ItemStack itemstack : this.items) {
            if (itemstack.isEmpty() || ItemStack.isSameItemSameTags(itemstack, pStack) && itemstack.getCount() <
