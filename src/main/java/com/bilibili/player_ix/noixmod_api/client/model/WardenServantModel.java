...
public class WardenServantModel<T extends WardenServant>
extends HierarchicalModel<T> {
    ...
    public WardenServantModel(ModelPart pRoot) {
        ...
        this.pulsatingSpotsLayerModelParts = ImmutableList.of(this.body, this.head, this.leftArm, this.rightArm, this.leftLeg,
                this.rightLeg);
    }
    ...
    private void animateTendrils(T pEntity, float pAgeInTicks, float pPartialTick) {
        float f = pEntity.getTendrilAnimation(pPartialTick) * (float)(Math.cos((double)pAgeInTicks * 2.25D) * Math.PI *
                (double)0.1F);
