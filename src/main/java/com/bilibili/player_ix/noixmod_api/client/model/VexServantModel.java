...
public class VexServantModel<T extends VexServant>
extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public VexServantModel(ModelPart p_171045_) {
    ...
    public void setupAnim(T p_104028_, float p_104029_, float p_104030_, float p_104031_, float p_104032_, float p_104033_) {
        ...
        this.head.yRot = p_104032_ * 0.017453292F;
        this.head.xRot = p_104033_ * 0.017453292F;
        float $$6 = Mth.cos(p_104031_ * 5.5F * 0.017453292F) * 0.1F;
        this.rightArm.zRot = 0.62831855F + $$6;
        this.leftArm.zRot = -(0.62831855F + $$6);
        if (p_104028_.getFlag() == 1) {
            this.body.xRot = 0.0F;
            this.setArmsCharging(p_104028_.getMainHandItem(), p_104028_.getOffhandItem(), $$6);
        } else {
            this.body.xRot = 0.15707964F;
        }
        this.leftWing.yRot = 1.0995574F + Mth.cos(p_104031_ * 45.836624F * 0.017453292F) * 0.017453292F * 16.2F;
