...
public class NeoIllagerRenderer<E extends NeoIllager>
extends IllagerServantRenderer<E> {
    public NeoIllagerRenderer(EntityRendererProvider.Context p_174304_) {
        ...
        this.addLayer(new ItemInHandLayer<>(this, p_174304_.getItemInHandRenderer()) {
            public void render(PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, E pLivingEntity,
    ...
    public ResourceLocation getTextureLocation(E pEntity) {
        return NoixmodAPI.location("textures/entities/illagers/servant/neo_illager.png");
    }
}
