...
public class ModGuardianModel<E extends GuardianServant>
extends HierarchicalModel<E> {
    ...
    public ModGuardianModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        for (int i = 0; i < 12; ++i) {
            ...
            head1.addOrReplaceChild(createSpikeName(i), cubelistbuilder, PartPose.offsetAndRotation(f, f1, f2, f3, f4, f5));
        }
        head1.addOrReplaceChild("eye", CubeListBuilder.create().texOffs(8, 0).addBox(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), PartPose.offset(0.0F, 0.0F, -8.25F));
        PartDefinition tail0 = head1.addOrReplaceChild("tail0", CubeListBuilder.create().texOffs(40, 0).addBox(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), PartPose.ZERO);
        PartDefinition tail1 = tail0.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(0, 54).addBox(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), PartPose.offset(-1.5F, 0.5F, 14.0F));
        tail1.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(41, 32).addBox(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).texOffs(25, 19).addBox(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), PartPose.offset(0.5F, 0.5F, 6.0F));
    ...
    public void setupAnim(E pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.head.yRot = pNetHeadYaw * Maths.PI_DIVIDING_180;
        this.head.xRot = pHeadPitch * Maths.PI_DIVIDING_180;
        ...
        if (entity != null) {
            ...
            Vec3 vec33 = (new Vec3(vec31.x - vec3.x, 0.0D, vec31.z - vec3.z)).normalize().yRot((Maths.PI / 2F));
        ...
        this.tailParts[0].yRot = Mth.sin(f2) * Maths.PI * 0.05F;
        this.tailParts[1].yRot = Mth.sin(f2) * Maths.PI * 0.1F;
        this.tailParts[2].yRot = Mth.sin(f2) * Maths.PI * 0.15F;
    }
