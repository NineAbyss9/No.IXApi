...
public class NihilisticServantRenderer<T extends NihilisticServant>
extends NihilistRenderer<T> {
    public NihilisticServantRenderer(EntityRendererProvider.Context $$0) {
    ...
    private static ResourceLocation LOC = new ResourceLocation("noixmodapi:textures/entities/nihilistic_mobs/nihilistic_servant.png");
