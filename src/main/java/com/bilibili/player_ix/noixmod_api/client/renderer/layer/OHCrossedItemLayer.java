...
public class OHCrossedItemLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private final ItemInHandRenderer itemInHandRenderer;

    public OHCrossedItemLayer(RenderLayerParent<T, M> p_234818_, ItemInHandRenderer p_234819_) {
        super(p_234818_);
    ...
    public void render(PoseStack p_116699_, MultiBufferSource p_116700_, int p_116701_, T p_116702_, float p_116703_, float p_116704_, float p_116705_, float p_116706_, float p_116707_, float p_116708_) {
        ...
        ItemStack $$10 = p_116702_.getItemBySlot(EquipmentSlot.OFFHAND);
        this.itemInHandRenderer.renderItem(p_116702_, $$10, ItemDisplayContext.GROUND, false, p_116699_, p_116700_, p_116701_);
        p_116699_.popPose();
    }
}
