...
@OnlyInClient
public class BiologistAnimations {
	public BiologistAnimations() {
	}
	...
	public static final AnimationDefinition attacking = AnimationDefinition.Builder.withLength(0.5F)
	...
	public static final AnimationDefinition ambient = AnimationDefinition.Builder.withLength(1.0F).looping()
			.addAnimation("left_tentacle", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
	...
	public static final AnimationDefinition summon1 = AnimationDefinition.Builder.withLength(0.5F)
			.addAnimation("left_hand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -150.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(-25.0F, 0.0F, -180.0F), AnimationChannel.Interpolations.LINEAR)
			))
