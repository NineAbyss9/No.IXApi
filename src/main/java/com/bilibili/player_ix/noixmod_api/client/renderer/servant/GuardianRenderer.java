...
import com.bilibili.player_ix.noixmod_api.client.model.ModGuardianModel;
...
public class GuardianRenderer<E extends GuardianServant>
extends MobRenderer<E, ModGuardianModel<E>> {
    ...
    public GuardianRenderer(EntityRendererProvider.Context pContext, float pRadius) {
        super(pContext, new ModGuardianModel<>(pContext.bakeLayer(ModelLayers.GUARDIAN)), pRadius);
    }
        ...
        if (super.shouldRender(pLivingEntity, pCamera, pCamX, pCamY, pCamZ)) {
            ...
            if (pLivingEntity.hasActiveAttackTarget()) {
                ...
                if (livingentity != null) {
                    ...
                    Vec3 vec31 = this.getPosition(pLivingEntity, pLivingEntity.getEyeHeight(), 1.0F);
    ...
    public static class Elder<E extends ElderGuardianServant> extends GuardianRenderer<E> {
        public static final ResourceLocation GUARDIAN_ELDER_LOCATION
                = new ResourceLocation("textures/entity/guardian_elder.png");
        public Elder(EntityRendererProvider.Context pContext) {
            super(pContext, 1.2F);
        }

        protected void scale(E pLivingEntity, PoseStack pPoseStack, float pPartialTickTime) {
            pPoseStack.scale(ElderGuardian.ELDER_SIZE_SCALE, ElderGuardian.ELDER_SIZE_SCALE,
                    ElderGuardian.ELDER_SIZE_SCALE);
        }
