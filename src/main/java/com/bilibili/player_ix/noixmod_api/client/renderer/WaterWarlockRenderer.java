...
public class WaterWarlockRenderer<T extends SpellcasterNihilist>
extends NihilistRenderer {
    ...
    public WaterWarlockRenderer(EntityRendererProvider.Context $$0) {
        ...
        this.addLayer(new ItemInHandLayer(this, $$0.getItemInHandRenderer()) {
            ...
            @Override
            public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int n, @NotNull LivingEntity livingEntity, float f, float f2, float f3, float f4, float f5, float f6) {
    ...
    @Override
    public void render(@NotNull LivingEntity livingEntity, float f, float f2, @NotNull PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int n) {
