...
import com.bilibili.player_ix.noixmod_api.entities.servant.illager.EvokerServant;
...
public class EvokerServantRenderer<T extends EvokerServant>
extends IllagerServantRenderer<T> {
    public EvokerServantRenderer(EntityRendererProvider.Context p_174304_) {
    ...
    public ResourceLocation getTextureLocation(T t) {
        return NoixmodAPI.location("textures/entities/illagers/servant/evoker.png");
    }
}
