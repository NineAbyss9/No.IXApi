...
import com.bilibili.player_ix.noixmod_api.entities.monster.Vampire;
...
public class VampireRenderer<T extends Vampire>
extends IllagerRenderer<T> {
    public static final ResourceLocation VAMPIRE =
            new ResourceLocation("noixmodapi:textures/entities/illagers/vampire.png");
