...
public class NihilisticFireballRenderer<T extends NihilisticFireball>
extends EntityRenderer<T> {
    private static final RenderType Render;
    private static final ResourceLocation Fireball;
    public NihilisticFireballRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }
    ...
    public void render(T p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        ...
        Matrix4f $$7 = $$6.pose();
        Matrix3f $$8 = $$6.normal();
        VertexConsumer $$9 = p_114084_.getBuffer(Render);
    ...
    static {
        Fireball = new ResourceLocation("noixmodapi:textures/entities/projectile/nihilistic_fireball.png");
        Render = RenderType.entityCutoutNoCull(Fireball);
    }
}
