...
import com.bilibili.player_ix.noixmod_api.entities.monster.nihilist.NihilisticDeath;
...
public class NihilisticDeathRenderer<T extends NihilisticDeath>
extends NihilistRenderer<T> {
    public NihilisticDeathRenderer(EntityRendererProvider.Context $$0) {
